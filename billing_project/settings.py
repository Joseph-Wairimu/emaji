...
# Merchant Transactions API (M-Pesa STK Push / C2B collections — not Daraja)
MERCHANT_API_BASE_URL = config('MERCHANT_API_BASE_URL', default='')
MERCHANT_API_CLIENT_ID = config('MERCHANT_API_CLIENT_ID', default='')
MERCHANT_API_CLIENT_SECRET = config('MERCHANT_API_CLIENT_SECRET', default='')
MERCHANT_API_WEBHOOK_SECRET = config('MERCHANT_API_WEBHOOK_SECRET', default='')
